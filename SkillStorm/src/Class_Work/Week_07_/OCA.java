package Class_Work.Week_07_;

import Class_Work.Week_07_.beans.Sedan;
import Class_Work.Week_07_.beans.Vehicle;
import Class_Work.Week_07_.beans.Vehicle.Color;
...
public class OCA {
    ...
    public static void enumTypes() {
        Sedan car1 = new Sedan(Color.ORANGE, "Toyota", "Camry");
