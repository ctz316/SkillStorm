package DailyProjects.week_03_Shape_Project.Main;

    public final class Rhombus extends Shapes_Variables_Hiding {

        // Constructors
            public Rhombus(String name, int middle_Length_In_Height, int middle_Length_In_Width){
                super(name, middle_Length_In_Height, middle_Length_In_Width);
            }

        // Variables
            private static final String sName = "Rhombus";
